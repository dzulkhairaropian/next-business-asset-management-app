...
@section('content')
    <div class="space-y-6">
        <x-common.page-breadcrumb pageTitle="Create New User" />
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-8">
                <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <!-- Password -->
                        <div>
                            <label class="mb-2.5 block font-medium text-gray-800 dark:text-white/90">Password</label>
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label class="mb-2.5 block font-medium text-gray-800 dark:text-white/90">Confirm Password</label>
